...
-keep public class com.agridata.cdzhdj.data.** {
    public void set*(***);
    public *** get*();
    public *** is*();
}
...
# 将下面替换成自己的实体类
-keep class com.agridata.cdzhdj.data.** { *; }
...
-keep class com.agridata.cdzhdj.greendao.gen.**{*;}
...
-keep public class com.agridata.cdzhdj.R$*{
