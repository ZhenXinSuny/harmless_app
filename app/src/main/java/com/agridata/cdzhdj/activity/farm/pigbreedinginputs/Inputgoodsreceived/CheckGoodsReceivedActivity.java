package com.agridata.cdzhdj.activity.farm.pigbreedinginputs.Inputgoodsreceived;
 ...
 * @Date : on 2023-05-11 15:08.
 * @Description :描述  投入品领用申请
 */
public class CheckGoodsReceivedActivity extends BaseActivity<ActivityBaseWebviewTitleBinding> {
    private final static String TAG = "lzx------》";
    private Handler mHandler = new Handler();
    private WebSettings webSettings;
    private static  final  String url= UrlUtils.YZTRPSH;
    private ImageEngine imageEngine;

    public static void start(Context context) {
        Intent intent = new Intent(context, CheckGoodsReceivedActivity.class);
    ...
    protected void initView() {
        binding.titlebarMiddle.setText("投入品领用审批");
