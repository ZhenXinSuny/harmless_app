 ...
 * @Description :描述
 */
public class YiRecordFragment extends BaseFragment<FragmentYiRecordBinding> {
    ...
    public static YiRecordFragment newInstance(String startTime, String endTime) {
        YiRecordFragment fragment = new YiRecordFragment();
