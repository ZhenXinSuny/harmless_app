 ...
 * @Date : on 2023-05-29 15:56.
 * @Description :描述
 */
public class ShengZhuYuFeiWebViewActivity extends BaseActivity<ActivityBaseWebviewTitleBinding> {
    ...
    public static void start(Context context, int menuId) {
        Intent intent = new Intent(context, ShengZhuYuFeiWebViewActivity.class);
    ...
    private void getArguments() {
        ...
        if (menuId==1) {
            binding.titlebarMiddle.setText("仔猪管理");
            url = UrlUtils.SZYF_ZZ;
        }else  if (menuId==2) {
            binding.titlebarMiddle.setText("商品猪管理");
            url = UrlUtils.SZYF_SPZ;
        }else  if (menuId==3) {
            binding.titlebarMiddle.setText("保供场可视化");
            url = UrlUtils.SZYF_SJTJ;
        }else  if (menuId==4) {
            binding.titlebarMiddle.setText("直联直报");
            url = UrlUtils.SZYF_ZLZB;
        }else  if (menuId==5) {
            binding.titlebarMiddle.setText("档案查看");
            url = UrlUtils.daianchakan;
        }
    ...
    protected void initView() {
        getArguments();
      //  binding.titlebarMiddle.setText("物品统计");
