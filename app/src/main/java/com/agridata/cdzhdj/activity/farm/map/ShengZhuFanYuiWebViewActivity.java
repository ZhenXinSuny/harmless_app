 ...
 * @Description :描述
 */
public class ShengZhuFanYuiWebViewActivity extends BaseActivity<ActivityBaseWebviewTitleBinding> {
    ...
    public static void start(Context context, int menuId) {
        Intent intent = new Intent(context, ShengZhuFanYuiWebViewActivity.class);
    ...
    private void getArguments() {
        ...
        if (menuId==1) {
            binding.titlebarMiddle.setText("育种管理");
            url = UrlUtils.SZFY_YZGL;
        }else  if (menuId==2) {
            binding.titlebarMiddle.setText("育肥管理");
            url = UrlUtils.SZFY_YFGL;
        }else  if (menuId==3) {
            binding.titlebarMiddle.setText("直联直报");
            url = UrlUtils.SZYF_ZLZB;
        }else  if (menuId==4) {
            binding.titlebarMiddle.setText("档案管理");
            url = UrlUtils.SZFY_DAGL;
        }
