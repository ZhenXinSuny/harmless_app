package com.agridata.cdzhdj.activity.entrycheck.bindslaughterhouse;
...
import com.agridata.cdzhdj.databinding.ActivityAddXdrWebBinding;
 ...
 * @Date : on 2023-05-09 14:42.
 * @Description :描述
 */
public class BindSlaughterhouseActivity  extends BaseActivity<ActivityAddXdrWebBinding> {
    private final static String TAG = "lzx------》";
    private Handler mHandler = new Handler();
    private WebSettings webSettings;
    private static  final  String url= UrlUtils.BindSlaughterhouse;
    private ImageEngine imageEngine;
    private String mTypeName;
    public static void start(Context context) {
        Intent intent = new Intent(context, BindSlaughterhouseActivity.class);
        context.startActivity(intent);
    }

    @Override
    protected ActivityAddXdrWebBinding getBinding() {
        return ActivityAddXdrWebBinding.inflate(getLayoutInflater());
    }

    @Override
    protected void initView() {
        binding.titlebarMiddle.setText("绑定屠宰场");
...
webSettings.setAppCacheEnabled(false);    //开启H5(APPCache)缓存功能
    ...
    public void writeData(){
        ...
        data.put(key4, vbm_saas_customer);
