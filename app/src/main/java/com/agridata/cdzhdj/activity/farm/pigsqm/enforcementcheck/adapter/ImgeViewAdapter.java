 ...
 * @Description :描述
 */
public class ImgeViewAdapter extends BaseRecyclerViewAdapter<ImageViewData, BaseRecyclerViewHolder> {

    private Context mContext;


    public ImgeViewAdapter(int layoutResId, Context mContext) {
