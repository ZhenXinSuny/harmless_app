 ...
 * @Date : on 2024-06-05 10:37.
 * @Description :描述
 */
public class PaperlessCertificationActivity extends BaseActivity<ActivityBaseWebviewTitleBinding> {
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, PaperlessCertificationActivity.class);
    ...
    protected void initView() {
        binding.titlebarMiddle.setText("无纸化出证");
        url = UrlUtils.WUZHIHUACHUZHENG;
