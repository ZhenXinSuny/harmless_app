 ...
 * @Date : on 2023-05-26 16:28.
 * @Description :描述  调入趋势图 In and out Trend chart
 */
public class AquaticWildlifeWebViewActivity extends BaseActivity<ActivityBaseWebviewTitleBinding> {
    private final static String TAG = "lzx------》";
    private Handler mHandler = new Handler();
    private WebSettings webSettings;
    private static  final  String url= UrlUtils.SSYSML;
    private ImageEngine imageEngine;

    public static void start(Context context) {
        Intent intent = new Intent(context, AquaticWildlifeWebViewActivity.class);
    ...
    protected void initView() {
        binding.titlebarMiddle.setText("水生野生动物名录查询");
