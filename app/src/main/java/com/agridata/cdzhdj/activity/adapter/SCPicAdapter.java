...
public class SCPicAdapter  extends BaseRecyclerViewAdapter<CollectedDetailBean.Result.ImgFiles.SiChuPicList, BaseRecyclerViewHolder> {

    private Context mContext;

    public SCPicAdapter(int layoutResId,Context mContext) {
        super(layoutResId, null);
        this.mContext = mContext;
    }

    @Override
    protected void convert(BaseRecyclerViewHolder viewHolder, CollectedDetailBean.Result.ImgFiles.SiChuPicList data, final int position) {
