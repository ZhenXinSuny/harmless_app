...
import com.agridata.cdzhdj.databinding.ActivityFeedStorageDetailsBinding;
 ...
 * @Description :描述
 */
public class FeedStorageDetailsActivity extends BaseActivity<ActivityFeedStorageDetailsBinding> {

    private String mid;
    private     CustomLoadingDialog mLoadingDialog;

    public static void start(Context context,String mid) {
        Intent intent = new Intent(context, FeedStorageDetailsActivity.class);
    ...
    @Override
    protected ActivityFeedStorageDetailsBinding getBinding() {
        return ActivityFeedStorageDetailsBinding.inflate(getLayoutInflater());
    }
    ...
    private void getFeedStorageDetails() {
        showLoading("正在加载中...");
        HttpRequest.getFeedStorageDetails(FeedStorageDetailsActivity.this, mid, new CallBackLis<FeedStorageDetails>() {
            @Override
    ...
    public void  setDetailsInfo(FeedStorageDetails.Result result ){
        ...
        binding.xdrNameTv.setText(result.farm.name);
    ...
    private void initLoadingView() {
        this.mLoadingDialog = new CustomLoadingDialog(FeedStorageDetailsActivity.this);
