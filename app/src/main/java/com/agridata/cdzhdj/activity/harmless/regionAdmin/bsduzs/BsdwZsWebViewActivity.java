package com.agridata.cdzhdj.activity.harmless.regionAdmin.bsduzs;
 ...
 * @time 14:04.
 */
public class BsdwZsWebViewActivity extends BaseActivity<ActivityWebviewBinding> {
    private final static String TAG = "lzx------》";
    private Handler mHandler = new Handler();
    private WebSettings webSettings;
    private static  final  String url= UrlUtils.QHBSDWZS;


    public static void start(Context context) {
        Intent intent = new Intent(context, BsdwZsWebViewActivity.class);
