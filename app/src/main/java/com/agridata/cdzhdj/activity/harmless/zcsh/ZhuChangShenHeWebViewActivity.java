package com.agridata.cdzhdj.activity.harmless.zcsh;
 ...
 * @time 14:04.
 */
public class ZhuChangShenHeWebViewActivity extends BaseActivity<ActivityWebviewBinding> {
    private final static String TAG = "lzx------》";
    private Handler mHandler = new Handler();
    private WebSettings webSettings;
    private static  final  String url= UrlUtils.ZCSH_URL;


    public static void start(Context context) {
        Intent intent = new Intent(context, ZhuChangShenHeWebViewActivity.class);
...
webSettings.setAppCacheEnabled(false);    //开启H5(APPCache)缓存功能
    ...
    private class JavaScriptCallbackThisJavaMethod {
        ...
        public void toActivity(String activityName) {
            ...
            CollectFillInActivity.start(ZhuChangShenHeWebViewActivity.this,activityName);
        ...
        public void toSignActivity(String activityName) {
            //此处应该定义常量对应，同时提供给web页面编写者
            LogUtil.d(TAG,activityName);
            JianDuYuanSignActivity.start(ZhuChangShenHeWebViewActivity.this,activityName,1004);
        }
