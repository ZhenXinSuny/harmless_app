package com.agridata.cdzhdj.activity.harmless.regionAdmin.bzt;
...
import com.agridata.cdzhdj.databinding.ActivityBztBinding;
...
public class BZTActivity extends BaseActivity<ActivityBztBinding> {
    private final static String TAG = "lzx------》";
    private Handler mHandler = new Handler();
    private WebSettings webSettings;
    private static  final  String url= UrlUtils.BING_SI_BZT;


    public static void start(Context context) {
        Intent intent = new Intent(context, BZTActivity.class);
        context.startActivity(intent);
    }

    @Override
    protected ActivityBztBinding getBinding() {
        return ActivityBztBinding.inflate(getLayoutInflater());
    }
