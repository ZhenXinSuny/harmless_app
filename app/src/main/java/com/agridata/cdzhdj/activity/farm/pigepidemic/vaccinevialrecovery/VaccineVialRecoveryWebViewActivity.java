package com.agridata.cdzhdj.activity.farm.pigepidemic.vaccinevialrecovery;
 ...
 * @Date : on 2023-06-26 11:24.
 * @Description :描述
 */
public class VaccineVialRecoveryWebViewActivity extends BaseActivity<ActivityBaseWebviewTitleBinding> {
    ...
    public static void start(Context context, int menuId) {
        Intent intent = new Intent(context, VaccineVialRecoveryWebViewActivity.class);
    ...
    private void getArguments() {
        ...
        if (menuId==1) {
            binding.titlebarMiddle.setText("苗瓶回收");
            url = UrlUtils.YiMiaoPingHuiShou;
        }
