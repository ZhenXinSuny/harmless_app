package com.agridata.cdzhdj.activity.farm.pigepidemic.map;
 ...
 * @Date : on 2023-07-27 16:25.
 * @Description :描述
 */
public class MianYiMapActivity extends BaseActivity<ActivityBaseWebviewTitleBinding> {
    ...
    public static void start(Context context, int menuId) {
        Intent intent = new Intent(context, MianYiMapActivity.class);
    ...
    private void getArguments() {
        ...
        if (menuId==1) {
            binding.titlebarMiddle.setText("免疫申报");
            url = UrlUtils.mianyi_shenbao;
        }else  if (menuId==2){
            binding.titlebarMiddle.setText("免疫受理");
            url = UrlUtils.mian_yi_shouli_and_bohui;
        } else if (menuId==3){
            binding.titlebarMiddle.setText("免疫驳回");
            url = UrlUtils.mian_yi_shouli_and_bohui;
        }else if (menuId==4){
            binding.titlebarMiddle.setText("免疫修改");
            url = UrlUtils.mian_yi_xiugai;
        }else  if (menuId==5){
            binding.titlebarMiddle.setText("免疫体系评价");
            url = UrlUtils.mainyi_tixi_pingjia;
        }
