 ...
 * @Date : on 2023-01-02 17:04.
 * @Description :描述
 */
public class EarTagOutActivity extends BaseActivity<ActivityEartagSignBinding> {
    private final static String TAG = "lzx------》";
    private Handler mHandler = new Handler();
    private WebSettings webSettings;
    private static  final  String url= UrlUtils.ERBIAOFAFANG; //"http://www.cdzhdj.cn/pages/plugins/form/form.html?fid=fa25330e924b4863bae09f7097f76c5e";  //UrlUtils.ERBIAOQIANSHOU;// //


    public static void start(Context context) {
        Intent intent = new Intent(context, EarTagOutActivity.class);
        context.startActivity(intent);
    }

    @Override
    protected ActivityEartagSignBinding getBinding() {
    ...
    protected void initView() {
        ...
        binding.titlebarMiddle.setText("耳标发放");
        ...
        syncCookie(url);
        new Handler().postDelayed(() -> binding.webView.loadUrl(url),800);
...
webSettings.setAppCacheEnabled(false);    //开启H5(APPCache)缓存功能
    ...
    private void settingWebViewClient() {
        binding.webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                binding.webView.evaluateJavascript("javascript:if(typeof String.prototype.replaceAll === \"undefined\") {\n" +
            ...
            public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
                ...
                switch (consoleMessage.messageLevel()){
                    ...
                    case ERROR://将error信息上报到服务端
                        ...
                        LogUtil.d("webview==",consoleMessage.message()+" level="+ consoleMessage.messageLevel());
                        break;
    ...
    public void writeData(){
        ...
        String key4 = "vbm_saas_fun";
        AppFunBean.Result appFunInfo = AppFunSP.getInstance().getAppFunInfo();
        String vbm_saas_fun = GsonUtil.toJson(appFunInfo);
        LogUtil.d(TAG,"vbm_saas_fun" + vbm_saas_fun);


        String key5 = "vbm_saas_customer";
        CustomerBean.Result customerInfo = AppFunSP.getInstance().getCustomerInfo();
        String vbm_saas_customer = GsonUtil.toJson(customerInfo);
        LogUtil.d(TAG,"customer" + vbm_saas_customer);
        ...
        data.put(key4, vbm_saas_fun);
        data.put(key5, vbm_saas_customer);
