package com.agridata.cdzhdj.activity.harmless.whhAdnim;
 ...
 * @time 14:04.
 */
public class WhhAdnimWebViewActivity extends BaseActivity<ActivityWebviewBinding> {
    private final static String TAG = "lzx------》";
    private Handler mHandler = new Handler();
    private WebSettings webSettings;
    private static  final  String url= UrlUtils.ADMIN_URL;


    public static void start(Context context) {
        Intent intent = new Intent(context, WhhAdnimWebViewActivity.class);
