...
public class JianDuYuanWebViewActivity extends BaseActivity<ActivityWebviewBinding> {
    ...
    private static  final  String url="http://192.173.1.106:5500/pages/harmless/chuliyuan/chuliyuanindex.html";


    public static void start(Context context) {
        Intent intent = new Intent(context, JianDuYuanWebViewActivity.class);
...
webSettings.setAppCacheEnabled(false);    //开启H5(APPCache)缓存功能
        ...
        switch (requestCode){
            case 1004:
                if (!TextUtils.isEmpty(data.getStringExtra("picMid"))){
                    ...
                    if (!picMid.equals("1")){
                        callVueJS(data.getStringExtra("picMid"));
    ...
    public void callVueJS(String id) {
    ...
    private class JavaScriptCallbackThisJavaMethod {
        ...
        public void toActivity(String activityName) {
            ...
            JianDuYuanSignActivity.start(JianDuYuanWebViewActivity.this,activityName,1004);
        }
    }
