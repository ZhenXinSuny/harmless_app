 ...
 * @Description :描述    发放
 */
public class IssueXdrActivity extends BaseActivity<ActivityWebviewBinding> {
    private final static String TAG = "lzx------》";
    private Handler mHandler = new Handler();
    private WebSettings webSettings;
    private static  final  String url= UrlUtils.FYY_XDR;
    private ImageEngine imageEngine;

    public static void start(Context context) {
        Intent intent = new Intent(context, IssueXdrActivity.class);
