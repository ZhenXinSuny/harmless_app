package com.agridata.cdzhdj.activity.farm.pigsqm.handlercase;
 ...
 * @Date : on 2023-08-07 09:20.
 * @Description :描述
 */
public class HandlerCaseActivity extends BaseActivity<ActivityBaseWebviewTitleBinding> {
    ...
    public static void start(Context context, int menuId) {
        Intent intent = new Intent(context, HandlerCaseActivity.class);
    ...
    private void getArguments() {
        ...
        if (menuId==1) {
            binding.titlebarMiddle.setText("执法办案");
            url = UrlUtils.ZFBA;
        }
    }
