...
public class EarTagSignActivity extends BaseActivity<ActivityEartagSignBinding> {
   ...
   private static  final  String url= UrlUtils.ERBIAOQIANSHOU; //"http://www.cdzhdj.cn/pages/plugins/form/form.html?fid=fa25330e924b4863bae09f7097f76c5e";  //UrlUtils.ERBIAOQIANSHOU;// //

    private boolean inWrited = false;
    public static void start(Context context) {
        Intent intent = new Intent(context, EarTagSignActivity.class);
