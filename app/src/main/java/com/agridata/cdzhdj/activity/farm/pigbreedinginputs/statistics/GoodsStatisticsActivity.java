package com.agridata.cdzhdj.activity.farm.pigbreedinginputs.statistics;
 ...
 * @Date : on 2023-05-12 15:40.
 * @Description :描述
 */
public class GoodsStatisticsActivity extends BaseActivity<ActivityBaseWebviewTitleBinding> {
    private final static String TAG = "lzx------》";
    private Handler mHandler = new Handler();
    private WebSettings webSettings;
    private static  final  String url= UrlUtils.WPTJ;
    private ImageEngine imageEngine;

    public static void start(Context context) {
        Intent intent = new Intent(context, GoodsStatisticsActivity.class);
