 ...
 */
public class GridImageZhuangCheAdapter extends RecyclerView.Adapter<GridImageZhuangCheAdapter.ViewHolder> {
    ...
    private onDelZCPicListener mOnDelZCPicListener;

    public void setDelZCPiC(onDelZCPicListener linstener) {
        this.mOnDelZCPicListener = linstener;
    }
    /**
     * 删除
     */
    ...
    public GridImageZhuangCheAdapter(Context context, List<LocalMedia> result) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            ...
            viewHolder.mIvDel.setOnClickListener(view -> {
                ...
                if (index != RecyclerView.NO_POSITION && list.size() > index) {
                    ...
                    mOnDelZCPicListener.deleteZCPic(index);
                }
            });
