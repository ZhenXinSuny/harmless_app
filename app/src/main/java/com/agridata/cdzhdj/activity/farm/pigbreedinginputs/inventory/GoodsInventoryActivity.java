package com.agridata.cdzhdj.activity.farm.pigbreedinginputs.inventory;
 ...
 * @Date : on 2023-05-12 17:12.
 * @Description :描述 物品盤點
 */
public class GoodsInventoryActivity extends BaseActivity<ActivityBaseWebviewTitleBinding> {
    private final static String TAG = "lzx------》";
    private Handler mHandler = new Handler();
    private WebSettings webSettings;
    private static  final  String url= UrlUtils.WPPD;
    private ImageEngine imageEngine;

    public static void start(Context context) {
        Intent intent = new Intent(context, GoodsInventoryActivity.class);
    ...
    protected void initView() {
        binding.titlebarMiddle.setText("物品盘点");
