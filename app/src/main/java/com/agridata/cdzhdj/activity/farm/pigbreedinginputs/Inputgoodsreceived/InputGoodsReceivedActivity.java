 ...
 */
public class InputGoodsReceivedActivity extends BaseActivity<ActivityBaseWebviewTitleBinding> {
    private final static String TAG = "lzx------》";
    private Handler mHandler = new Handler();
    private WebSettings webSettings;
    private static  final  String url= UrlUtils.TRPLY;
    private ImageEngine imageEngine;

    public static void start(Context context) {
        Intent intent = new Intent(context, InputGoodsReceivedActivity.class);
    ...
    protected void initView() {
        binding.titlebarMiddle.setText("投入品领用申请");
