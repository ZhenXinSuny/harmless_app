 ...
 * @Date : on 2023-05-10 14:28.
 * @Description :描述    发放
 */
public class BeastsBirdSWebViewActivity extends BaseActivity<ActivityBaseWebviewTitleBinding> {
    private final static String TAG = "lzx------》";
    private Handler mHandler = new Handler();
    private WebSettings webSettings;
    private static  final  String url= UrlUtils.XQMU;
    private ImageEngine imageEngine;

    public static void start(Context context) {
        Intent intent = new Intent(context, BeastsBirdSWebViewActivity.class);
    ...
    protected void initView() {
        binding.titlebarMiddle.setText("畜禽种资质源目录");
