...
public class ZCPicAdapter extends BaseRecyclerViewAdapter<CollectedDetailBean.Result.ImgFiles.ZhuangChePicList, BaseRecyclerViewHolder> {
    ...
    public ZCPicAdapter(int layoutResId, Context mContext) {
        super(layoutResId, null);
        this.mContext = mContext;
    }

    @Override
    protected void convert(BaseRecyclerViewHolder viewHolder, CollectedDetailBean.Result.ImgFiles.ZhuangChePicList data, final int position) {
