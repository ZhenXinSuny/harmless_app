 ...
 * @Description :描述
 */
public class NoFishAreaWebViewActivity extends BaseActivity<ActivityBaseWebviewTitleBinding> {
    private final static String TAG = "lzx------》";
    private Handler mHandler = new Handler();
    private WebSettings webSettings;
    private static  final  String url= UrlUtils.JYQY; //  JYQY  SSYSML
    private ImageEngine imageEngine;

    public static void start(Context context) {
        Intent intent = new Intent(context, NoFishAreaWebViewActivity.class);
    ...
    protected void initView() {
        binding.titlebarMiddle.setText("禁渔区名录查询");
