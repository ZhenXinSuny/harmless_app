 ...
 */
public class GridImageDeathAdapter extends RecyclerView.Adapter<GridImageDeathAdapter.ViewHolder> {
    ...
    private onDelSiChuPicListener mOnDelSCPicListener;

    public void setDelSiChuPiC(onDelSiChuPicListener linstener) {
        this.mOnDelSCPicListener = linstener;
    }
    ...
    public GridImageDeathAdapter(Context context, List<LocalMedia> result) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            ...
            viewHolder.mIvDel.setOnClickListener(view -> {
                ...
                if (index != RecyclerView.NO_POSITION && list.size() > index) {
                    ...
                    mOnDelSCPicListener.deleteSiChuPic(index);
                }
            });
