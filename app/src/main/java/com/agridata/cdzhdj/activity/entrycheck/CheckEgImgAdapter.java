...
import com.agridata.cdzhdj.activity.adapter.OnItemLongClickListener;
 ...
 * @Date : on 2022-12-27 09:29.
 * @Description :描述
 */
public class CheckEgImgAdapter extends RecyclerView.Adapter<CheckEgImgAdapter.ViewHolder> {
    ...
    public CheckEgImgAdapter(Context context, List<LocalMedia> result) {
